    ...
    async def generate(
        ...
        *,
        ...
        with torch.no_grad():
            ...
            for i, prompt_token_ids in enumerate(tokenized_prompts):
                self._engine.add_request(
                    str(i), {"prompt_token_ids": prompt_token_ids}, sampling_params
                )
            ...
            for output in all_outputs:
                ...
                # TODO: When renderer-owned prompt construction lands, check
                # if we should return the output prompt token IDs
                # or keep the input prompt token IDs
                output_prompt_token_ids = output.prompt_token_ids
                ...
                for sample in output.outputs:
                    ...
                    completions.append(
                        Completion(
                            ...
                            prompt_token_ids=output_prompt_token_ids,
                            text=sample.text,
